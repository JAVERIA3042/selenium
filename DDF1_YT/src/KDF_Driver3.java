...
static String xlPath_Res = "C:\\Users\\Javeria Khaliq\\eclipse-workspace\\EXCEl\\KDF5_YT_HardCoded_Res.xls";
 static WebDriver myD;
public static void main(String[]args) throws Exception {
	String vTCID, vTC_Exe,vTC_Desc;
	String vTSID, vTS_StepNum, vKeyword, vData, vEID, vTS_Res, vTS_Error, vTS_Screenshot; 
	...
	writeXL (xlPath_Res, "TestCases", xTC);
