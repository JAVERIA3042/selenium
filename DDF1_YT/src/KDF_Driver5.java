...
static String xlPath = "C:\\Users\\Javeria Khaliq\\eclipse-workspace\\EXCEl\\KDF6_YT_HardCoded.xls";
static String xlPath_ResTC = "C:\\Users\\Javeria Khaliq\\eclipse-workspace\\EXCEl\\Results\\Res_TC.xls";
static String xlPath_ResTS = "C:\\Users\\Javeria Khaliq\\eclipse-workspace\\EXCEl\\Results\\Res_TS.xls";

 static WebDriver myD;
public static void main(String[]args) throws Exception {
	String vTCID, vTC_Exe,vTC_Desc;
	String vTSID, vKeyword, vData, vEID, vTS_Res, vTS_Error, vTS_Screenshot;
	String vTS_StepNum; 
	long vTimeTC_Start, vTimeTC_End, vTimeTC_Total;
	...
	for( int i=1 ; i<xTC_R ; i++) {
		...
		if(vTC_Exe.equals("Y")) {
			...
			vTimeTC_Start = System.currentTimeMillis();
			xTC[i][3] = "Pass";
			...
			for(int j =1; j< xTS_R; j++) {
				...
				if(vTCID.equals(vTSID)) { // Execute only matching TCID
					...
					System.out.println("Step >>>>>>>>>>>Pass");
						...
						FileUtils.copyFile(scrFile, new File("C:\\Users\\Javeria Khaliq\\eclipse-workspace\\EXCEl\\Results\\Screenshot\\"+ vTCID + "-" + vTS_StepNum + ".jpg" ));
						xTS[j][8] = "C:\\Users\\Javeria Khaliq\\eclipse-workspace\\EXCEl\\Results\\Screenshot\\"+ vTCID + "-" + vTS_StepNum + ".jpg";
					}
				}
				else {					 
				  }
				}	
			// Stop timing the Test case.
			vTimeTC_End = System.currentTimeMillis();
			vTimeTC_Total = vTimeTC_End - vTimeTC_Start;
			System.out.println("Time taken for this Test case is " + vTimeTC_Total);
			xTC[i][4] = Long.toString(vTimeTC_Total/1000); 
		}else {
			xTC[i][3] = "Skipped";
	...
	writeXL (xlPath_ResTC, "TestCases", xTC);
	writeXL (xlPath_ResTS, "TestSteps", xTS);
